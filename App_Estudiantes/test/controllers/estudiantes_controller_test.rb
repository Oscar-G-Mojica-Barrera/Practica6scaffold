...
class EstudiantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estudiante" do
    assert_difference("Estudiante.count") do
      post estudiantes_url, params: { estudiante: { apellido: @estudiante.apellido, carnet: @estudiante.carnet, carrera: @estudiante.carrera, celular: @estudiante.celular, fecha_nacimiento: @estudiante.fecha_nacimiento, nombre: @estudiante.nombre } }
    end
  ...
  test "should update estudiante" do
    patch estudiante_url(@estudiante), params: { estudiante: { apellido: @estudiante.apellido, carnet: @estudiante.carnet, carrera: @estudiante.carrera, celular: @estudiante.celular, fecha_nacimiento: @estudiante.fecha_nacimiento, nombre: @estudiante.nombre } }
